...
Verify integration recommendations and endpoint details against the current official Stripe documentation. Preserve an existing pinned API version unless the user has approved a reviewed migration.
